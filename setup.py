...
setup(name='sqlalchemy_mixins',
      ...
      url='https://github.com/mdconaway/sqlalchemy-mixins',
      download_url='https://github.com/mdconaway/sqlalchemy-mixins/archive/master.tar.gz',
      author='Michael Conaway',
      author_email='mdconaway@noreply.github.com',
      license='MIT',
